...
export const routes: Routes = [
    ...
    {path:'shippingaddress/:cartid',data: { renderMode: 'no-prerender' }, component:ShippingAdressComponent,canActivate:[authGuard] ,title:"shippingaddress"},
    ...
    { path: 'productDetails/:_id',data: { renderMode: 'no-prerender' }, component:ProductDetailsComponent,canActivate:[authGuard] , title: "productDetails" },
